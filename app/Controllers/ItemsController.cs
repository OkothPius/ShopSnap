...
namespace ShopSnap.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductName,ProductPrice")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductName,ProductPrice")] Item item)
        {
            if (id != item.Id)
            {
                return NotFound();
